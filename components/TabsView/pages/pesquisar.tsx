...
export default function TabSearch() {
  ...
  return (
    <View className="flex-1 w-full justify-center items-center">
      <View className="flex-row w-80 h-14 px-2 self-center items-center rounded-lg border-2 border-white/60 ">
        <Ionicons name="ios-search" size={32} color="white" />
        <TextInput
          className="w-80 h-12 px-2 font-default text-white rounded-xl text-lg"
          ...
          return (
            <View className="flex-row w-80 h-22 py-2 my-2 self-center items-center rounded-lg bg-gray-400/20">
              ...
              <View className="w-80 rounded-lg">
                ...
                <Text numberOfLines={1} className="font-default text-gray-300">
                  {item.question2}
                </Text>
              </View>
