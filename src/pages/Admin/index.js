...
const logged = {
  ...
  idade: 27,
  avatar:
    "https://instagram.fjpa9-1.fna.fbcdn.net/v/t51.2885-19/363793891_247920134771958_5616203686962323957_n.jpg?stp=dst-jpg_s150x150&_nc_ht=instagram.fjpa9-1.fna.fbcdn.net&_nc_cat=106&_nc_ohc=IKaaGNRj1mkAX-44Eds&edm=ACWDqb8BAAAA&ccb=7-5&oh=00_AfDvuRg6DxA_qL-ZwayTw-_uTmLXGufzBStY4dahzcCRGg&oe=64E69A51&_nc_sid=ee9879",
      ...
      <Box flex={1} flexDir="column" justifyContent="center">
        <Animatable.View animation="slideInDown" duration={1000} delay={200}>
          <Box
            ...
            roundedBottom="20"
          >
            <Text fontSize="2xl" marginTop="10" color="white">
